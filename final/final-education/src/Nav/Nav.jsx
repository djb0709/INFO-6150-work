            ...
            <ul className="nav-menu">
                ...
                <li className='menu-item'>
                    <a onClick={changePage} href="/">
                        {/* google font */}
                        <svg xmlns="http://www.w3.org/2000/svg" className='nav-svg' height="20px" viewBox="0 -960 960 960" width="20px" >
                ...
                <li className='menu-item'>
                    <a onClick={changePage} href="/courses">
                        {/* google font */}
                        <svg xmlns="http://www.w3.org/2000/svg" className='nav-svg' height="20px" viewBox="0 -960 960 960" width="20px">
                ...
                <li className='menu-item'>
                    <a onClick={changePage} href="/about">
                        {/* google font */}
                        <svg xmlns="http://www.w3.org/2000/svg" className='nav-svg' height="20px" viewBox="0 -960 960 960" width="20px" >
